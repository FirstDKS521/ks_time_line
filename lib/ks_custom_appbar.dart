...
class KSCustomAppbar extends StatefulWidget implements PreferredSizeWidget {
...
class _CustomAppbarState extends State<KSCustomAppbar> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return new Container(
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage('lib/res/home/nav_img.png'),
          fit: BoxFit.cover
        ),
      ),
      child: new SafeArea(
